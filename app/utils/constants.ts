...
export const COOKIE_MAX_AGE = 20; // 200 seconds
...
export const GOOGLE_REDIRECT_URI = `${process.env.EXPO_PUBLIC_API_URL}/api/auth/callback`;
...
// export const APPLE_REDIRECT_URI = `${process.env.EXPO_PUBLIC_API_URL}/api/auth/apple/callback`;
