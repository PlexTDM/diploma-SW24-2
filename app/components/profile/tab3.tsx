    ...
    <ScrollView className="p-4">
      <View className="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-sm mt-8">
        ...
        <View className="flex-row justify-center space-x-1">
          <ThemeText className="font-bold text-xl text-[#E9509F]">{yourSteps}</ThemeText>
          <ThemeText className="text-lg text-gray-500 mx-2">vs</ThemeText>
          <Text className="font-bold text-xl text-blue-500 dark:text-blue-400">{alexSteps}</Text>
        </View>

        {/* Progress Bars */}
        <View className="flex-row items-center">
          <View className="mr-4 bg-gray-200 dark:bg-gray-700 p-3 rounded-full">
            <Icon source="run-fast" size={36} color={theme === "dark" ? "#fff" : "#000"} />
          </View>
