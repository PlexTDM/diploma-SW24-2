...
export default function StepsModal({ visible, setVisible }: StepsModalProps) {
    ...
    const pencilColor = colorScheme === "dark" ? "#d1d5db" : "#4b5563"; 
            ...
            <ScrollView>
                <ThemeView className="flex-1 pt-6 px-6 ">
                    ...
                    <View className="bg-white dark:bg-gray-900 rounded-2xl  border border-gray-200 dark:border-gray-700 flex-row p-6 justify-between items-center mb-6">
                        {/* Left side: Today */}
                        <View className="absolute top-5 left-8"> <Footprints size={25} color="#3b82f6" className="mb-1" /></View>
                        <View className="flex-1 items-center">
                           
                            <Text className="text-xl text-gray-400 dark:text-gray-400 mb-1 font-quicksand font-bold">Today</Text>
                            <Text className="text-2xl font-bold text-blue-600">{todaySteps}</Text>
                        </View>
                        ...
                        <View className="flex-1 items-center justify-center gap-1">
                            <Text className="text-xl text-gray-400 dark:text-gray-400  font-quicksand font-bold">Daily step goal</Text>
                            ...
                            {isEditing ? (
                                ...
                                <Text className="text-2xl font-bold text-gray-800 dark:text-white">{goal}</Text>
                            )}
                    ...
                    <ThemeText className="text-gray-400 text-sm text-center dark:text-gray-400">To keep you active we recommend a minimum of 10,000 steps</ThemeText>
